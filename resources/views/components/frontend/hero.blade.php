    ...
    <div class="container mx-auto h-full">
        <div class="flex flex-col lg:flex-row items-center h-full pt-8">
            <div class="flex-1 flex flex-col items-center lg:items-start">
                <p class="text-lg text-accent text-md mb-[22px]">Hey, I'm Adi! 👋</p>
                <h1
                    class="text-4xl leading-[44px] md:text-5xl md:leading-tight md:tracking-[-2px] lg:text-7xl lg:leading-[1.2] font-bold">
                    I'm a Web Developer</h1>
                <p class="pt-4 pb-8 md:pt-6 md:pb-12 max-w-[480px] text-lg text-center lg:text-left text-gray-400">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia, facilis.
                </p>
                <button
                    class="btn btn-md bg-accent hover:bg-light-secondary hover:text-light-tale-500 dark:hover:bg-dark-secondary dark:hover:text-dark-navy-100 md:btn-lg transition-all">
                    Work With Me
                </button>
                <div class="pt-12">
                ...
                <div class="flex items-center mb-6">
                    <a href="https://facebook.com/adixboy"
                        class="text-white bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-2 mb-2 truncate">
                    ...
                    <a href="https://github.com/AdiDahari"
                    ...
                    <a href="mailto:dahariadi16@gmail.com"
                    ...
                    <a href="https://linkedin.com/in/adi-dahari"
                        class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
                        <svg fill="#000000" width="800px" height="800px" viewBox="-2 -2 24 24"
                            xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin"
                            class="jam jam-linkedin-square w-5 h-5 mr-2 -ml-1">
                            <path
            ...
            <div class="flex flex-1 justify-end items-center h-full mt-8 md:mt-0">
                <img src="/img/hero.jpg" alt="" class="rounded-lg">
            </div>
        </div>
    </div>
</section>
